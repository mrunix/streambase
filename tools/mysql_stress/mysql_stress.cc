 ...
 public:
  ...
  static const char* getDataTypeStr(const DataType& iDataType) {
    ...
    case MYSQL_TYPE_LONGLONG           :
      return "int";
    case MYSQL_TYPE_DISTINCT_LONGLONG  :
      return "distinct_int";
    case MYSQL_TYPE_DEPENDENT_LONGLONG :
      return "dependent_int";
    default                            :
      return "unknown_type";
    }
  }
  ...
  static const char* getGenTypeStr(const GenType& iGenType) {
    switch (iGenType) {
    case GEN_TYPE_PARALLEL_LOOP       :
      return "parallel_loop";
    case GEN_TYPE_NESTED_LOOP         :
      return "nested_loop";
    default                           :
      return "unknown_gen_type";
    }
  }
