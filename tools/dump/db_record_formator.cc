 ...
 * =====================================================================================
 *
 *       Filename:  db_record_formator.cc
 *
 *    Description:
 *
 *        Version:  1.0
...
int DbRecordFormator::format_record(int64_t table_id, DbRecord* record,
  ...
  if (ret == OB_SUCCESS) {
    ...
    TBSYS_LOG(ERROR, "DbRecordFormator can't find table id [%d]", table_id);
  }
