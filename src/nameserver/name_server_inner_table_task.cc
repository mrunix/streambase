...
#include "name_server_inner_table_task.h"
#include "name_server_async_task_queue.h"
#include "name_server_sql_proxy.h"

using namespace sb::common;
using namespace sb::nameserver;

NameServerInnerTableTask::NameServerInnerTableTask(): cluster_id_(-1), timer_(NULL), queue_(NULL), proxy_(NULL) {
}

NameServerInnerTableTask::~NameServerInnerTableTask() {
}
...
int NameServerInnerTableTask::modify_all_server_table(const NameServerAsyncTaskQueue::ObSeqTask& task) {
  int ret = OB_SUCCESS;
...
int NameServerInnerTableTask::modify_all_cluster_table(const NameServerAsyncTaskQueue::ObSeqTask& task) {
  int ret = OB_SUCCESS;
...
void NameServerInnerTableTask::runTimerTask(void) {
...
int NameServerInnerTableTask::process_head_task(void) {
  ...
  // pop the succ task
  if (OB_SUCCESS == ret) {
    NameServerAsyncTaskQueue::ObSeqTask pop_task;
