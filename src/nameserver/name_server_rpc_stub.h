#ifndef SRC_NAMESERVER_NAME_SERVER_RPC_STUB_H_
#define SRC_NAMESERVER_NAME_SERVER_RPC_STUB_H_
...
class NameServerRpcStub: public common::ObCommonRpcStub {
 public:
  ...
  virtual int fetch_slave_cluster_list(const common::ObServer& ms, const common::ObServer& master_rs,
                                       common::ObServer* slave_cluster_rs, int64_t& ns_count, int64_t timeout);
...
#endif /* SRC_NAMESERVER_NAME_SERVER_RPC_STUB_H_ */
