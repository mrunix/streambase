...
class NameServerConfig
 ...
 public:
  ...
  int get_master_name_server(ObServer& server) const;
 ...
 public:
  ...
  DEF_BOOL(lease_on, "True", "lease switch between master and slave nameserver");
  ...
  DEF_IP(master_name_server_ip, "0.0.0.0", "master OceanBase instance vip address");
  DEF_INT(master_name_server_port, "0", "master OceanBase instance listen port");
};
}
}
