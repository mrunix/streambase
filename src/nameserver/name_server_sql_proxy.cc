...
NameServerSQLProxy::~NameServerSQLProxy() {
}
int NameServerSQLProxy::query(const bool query_master_cluster, const int64_t retry_times, const int64_t timeout, const common::ObString& sql) {
  int ret = OB_SUCCESS;
  ObServer server;
  int64_t count = 0;
  do {
...
int NameServerSQLProxy::query(const int64_t retry_times, const int64_t timeout, const common::ObString& sql) {
  int ret = OB_SUCCESS;
  ObServer server;
  int64_t count = 0;
  do {
