...
class NameServer {
 ...
 public:
  ...
  // for bypass
  // start_import is called in master cluster by ns_admin, this method will call import on all clusters
  ...
  // start_kill_import is called in master cluster by ns_admin, this method will call kill_import on all clusters
  ...
  NameServerBalancer* get_balancer() { return balancer_; }
  ...
  NameServerRpcStub& get_rpc_stub();
  ...
  // get task queue
  NameServerAsyncTaskQueue* get_task_queue(void);
  ...
  NameServerOperationHelper* get_bypass_operation();
  ...
  NameServerMsProvider& get_ms_provider() { return ms_provider_; }
 ...
 private:
  ...
  NameServerDDLOperator ddl_tool_;
