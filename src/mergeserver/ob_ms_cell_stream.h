...
class ObMSCellStream: public ObUPSCellStream {
 public:
  // construct
 ...
 protected:
  ...
  sb::common::ObCellInfo* last_cell_;  // last iterator cell
  sb::common::ObCellInfo* cur_cell_;   // current iterator cell
