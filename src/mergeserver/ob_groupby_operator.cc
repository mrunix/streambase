...
sb::mergeserver::ObGroupByOperator::ObGroupByOperator() {
  param_ = NULL;
  inited_ = false;
...
void sb::mergeserver::ObGroupByOperator::clear() {
...
int sb::mergeserver::ObGroupByOperator::init(const ObGroupByParam& param,
...
int sb::mergeserver::ObGroupByOperator::init_all_in_one_group_row() {
  int err = OB_SUCCESS;
...
int sb::mergeserver::ObGroupByOperator::add_row(const ObCellArray& org_cells,
