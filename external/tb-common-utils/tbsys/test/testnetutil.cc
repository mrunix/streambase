...
void test1() {
  ...
  uint64_t x;
  int port = 1234;
  x = CNetUtil::strToAddr("192.168.207.11", port);
  m.insert(x);
  x = CNetUtil::strToAddr("192.168.207.12", port);
  m.insert(x);
  x = CNetUtil::strToAddr("192.168.207.12", port + 1);
  m.insert(x);
  x = CNetUtil::strToAddr("192.168.207.12", port - 1);
  m.insert(x);
  x = CNetUtil::strToAddr("92.168.207.191", port);
  m.insert(x);
  x = CNetUtil::strToAddr("172.168.207.192", port);
  m.insert(x);
  x = CNetUtil::strToAddr("172.168.207.12", port);
  m.insert(x);
  x = CNetUtil::strToAddr("172.169.207.12", port);
  m.insert(x);
  x = CNetUtil::strToAddr("172.168.207.13", port);
  m.insert(x);
  x = CNetUtil::strToAddr("182.168.207.11", port);
  m.insert(x);
  x = CNetUtil::strToAddr("182.168.207.12", port);
  m.insert(x);
  x = CNetUtil::strToAddr("182.169.207.12", port);
  m.insert(x);
  x = CNetUtil::strToAddr("182.168.207.13", port);
  m.insert(x);
