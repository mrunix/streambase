...
class MockUpsTableMgr : public ObIUpsTableMgr {
 public:
  MockUpsTableMgr() {
    ...
    col.set_table_id(1001);
    col.set_column_id(16);
    col.set_column_name("rk1");
    col.set_column_type(ObIntType);
    cschema.add_column(col);
    col.set_table_id(1001);
    col.set_column_id(17);
    col.set_column_name("rk2");
    col.set_column_type(ObIntType);
    cschema.add_column(col);
    col.set_table_id(1001);
    col.set_column_id(101);
    col.set_column_name("c1");
    col.set_column_type(ObIntType);
    cschema.add_column(col);
    col.set_table_id(1001);
    col.set_column_id(102);
    col.set_column_name("c2");
    col.set_column_type(ObIntType);
    cschema.add_column(col);
